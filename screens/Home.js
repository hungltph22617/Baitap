...
const HomeScreen = ({ navigation }) => {
    ...
    async function getListStudent() {
        try {
            const API_URL = 'http://192.168.0.101:3000/students';
                        ...
                        return (
                            <View style={styles.item} key={index}>
                                <View style={styles.itemImageContainer}>
                                    {item.gender === 'Male' ? (
                                        <Image style={styles.itemImage} source={require('../assets/Image/male.png')} resizeMode='contain' />
                                    ) : (
                                        <Image style={styles.itemImage} source={require('../assets/Image/female.png')} resizeMode='contain' />
                                    )}
                                </View>
